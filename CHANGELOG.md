...
- Migrates Android Gradle configuration for Flutter built-in Kotlin compatibility.
- Applies Kotlin Gradle Plugin only when Android Gradle Plugin is earlier than 9 to preserve compatibility with older Flutter/AGP projects.
- Updates Kotlin compiler options configuration to use the new compilerOptions DSL.
